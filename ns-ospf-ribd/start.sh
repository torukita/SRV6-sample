...
#     BD - fc00:00bd::/64
#
#     host1 encaps dest address(fc00:000b::10) as seg6 via fc00:0003::10
#     host2 encaps dest address(fc00:000a::10) as seg6 via fc00:0003::10
#
...
destroy_network () {
    ...
    run ip netns exec host1 ./host1/init.sh stop
    run ip netns del host1
    run ip netns exec host2 ./host2/init.sh stop    
